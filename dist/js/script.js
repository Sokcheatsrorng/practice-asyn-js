...
const renderCard = ({title, price, images})=>{
    ...
    <div
          ...
          <div class="block h-72 overflow-hidden w-full">
            <img class="w-full h-full rounded-t-lg object-center"
              src="${images[0]}"
              alt="product image"/>
          </div>
          <div class="px-5 pb-5">
            <a href="#">
              <h5
                class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">${title}</h5>
            </a>
